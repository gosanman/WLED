...
```[platformio]
default_envs = custom_esp32_eth_knx

[env:custom_esp32_eth_knx]
...
lib_deps = ${esp32.lib_deps}
   ...
   https://github.com/gosanman/arduino-tpuart-knx-user-forum
build_flags = ${common.build_flags_esp32} 
   -D WLED_RELEASE_NAME=ESP32_Ethernet_KNX 
   -D USERMOD_KNX 
   -D RLYPIN=-1 
   -D BTNPIN=-1 
   -D WLED_USE_ETHERNET 
